...
void _http_end_response(http_request_t* request, http_response_t* response, grwprintf_t* printctx, hs_req_fn_t http_write) {
  http_header_t* header = response->headers;
  while (header) {
...
void hs_response_header(http_response_t* response, char const * key, char const * value) {
...
void hs_respond(http_request_t* request, http_response_t* response, hs_req_fn_t http_write) {
  grwprintf_t printctx;
...
void hs_respond_chunk_end(http_request_t* request, http_response_t* response, hs_req_fn_t http_write) {
  grwprintf_t printctx;
  _grwprintf_init(&printctx, HTTP_RESPONSE_BUF_SIZE, &request->server->memused);
...
void hs_respond_error(http_request_t* request, int code, char const * message, hs_req_fn_t http_write) {
